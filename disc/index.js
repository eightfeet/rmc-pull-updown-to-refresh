...
var loading = React__default["default"].createElement("span", { className: s.loadingico },
    React__default["default"].createElement("svg", { className: "lds-palette-ring", xmlns: "http://www.w3.org/2000/svg", viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid" },
        React__default["default"].createElement("g", { transform: "rotate(150 50 50)" },
            React__default["default"].createElement("path", { d: "M80 50a30 30 0 0 1-20.73 28.532", fill: "none", stroke: "#ffffcb", strokeWidth: 10 }),
            React__default["default"].createElement("path", { d: "M59.27 78.532a30 30 0 0 1-33.54-10.898", fill: "none", stroke: "#fac090", strokeWidth: 10 }),
            React__default["default"].createElement("path", { d: "M25.73 67.634a30 30 0 0 1 0-35.268", fill: "none", stroke: "#ff7c81", strokeWidth: 10 }),
            React__default["default"].createElement("path", { d: "M25.73 32.366a30 30 0 0 1 33.54-10.898", fill: "none", stroke: "#c0f6d2", strokeWidth: 10 }),
            React__default["default"].createElement("path", { d: "M59.27 21.468A30 30 0 0 1 80 50", fill: "none", stroke: "#dae4bf", strokeWidth: 10 }),
            React__default["default"].createElement("animateTransform", { attributeName: "transform", type: "rotate", values: "0 50 50;360 50 50", dur: 1, repeatCount: "indefinite" }))));
var arrow = React__default["default"].createElement("span", { className: s.arrowico },
    React__default["default"].createElement("svg", { xmlns: "http://www.w3.org/2000/svg", viewBox: "-359 361 80 80", xmlSpace: "preserve" },
        React__default["default"].createElement("path", { d: "M-322.2 373.6c-12.6 1.4-22.7 11.5-24.2 24.1-1.5 12.8 5.7 24.1 16.6 28.8 0-2.5-1.2-4.9-3.2-6.4-6.6-4.9-10.5-13.1-9.3-22.2 1.4-10.6 10.1-19.1 20.7-20.3 14.2-1.6 26.3 9.6 26.3 23.5 0 12.4-9.5 22.5-21.6 23.5v-30l3.4 3.4c1.3 1.3 3.4.4 3.4-1.4v-.1c0-.5-.2-1-.6-1.4l-6.8-6.8c-.8-.8-2-.8-2.8 0l-6.8 6.8c-.4.4-.6.9-.6 1.4v.1c0 1.8 2.2 2.7 3.4 1.4l3.4-3.4v34c.7 0 1.3.1 2 .1 15.2 0 27.6-12.4 27.6-27.6-.1-16.4-14.2-29.4-30.9-27.5z", style: {
                fill: "gray",
            } })));
...
var PullToRefresh = /** @class */ (function (_super) {
    ...
    PullToRefresh.prototype.render = function () {
        ...
        return (React__default["default"].createElement("div", { ref: function (el) {
            ...
            debug && React__default["default"].createElement("div", { className: s.debug }, debug),
            React__default["default"].createElement("div", { ref: function (el) {
                    _this.drogbox = el;
                }, className: s.drogbox, style: drogboxstyle },
                React__default["default"].createElement("div", { className: "".concat(s.drogbar, " ").concat(this.props.loadingClassName), style: loadingstyle },
                    React__default["default"].createElement("div", { className: "".concat(s.top, " ").concat(s.loading) },
                        showLoading && this.props.loadIcon,
                        showArrow && (React__default["default"].createElement("span", { className: s.arrowico, style: arrowstyle },
                            React__default["default"].createElement("div", { className: s.arrowup }, this.props.pullIcon))),
                        loadingtext,
                        errMsg)),
                React__default["default"].createElement("div", { ref: function (el) {
                        _this.listwrap = el;
                ...
                React__default["default"].createElement("div", { className: "".concat(s.drogbar, " ").concat(this.props.loadingClassName), style: loadingstyle },
                    React__default["default"].createElement("div", { className: s.loading },
                        showLoading && this.props.loadIcon,
                        showArrow && (React__default["default"].createElement("span", { className: s.arrowico, style: arrowstyle },
                            React__default["default"].createElement("span", { className: s.arrowbottom }, this.props.pullIcon))),
                        loadingtext,
                        errMsg)))));
    };
